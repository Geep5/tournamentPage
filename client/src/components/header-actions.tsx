    ...
    <div className="flex items-center gap-2 shrink-0">
      ...
      <Popover>
        ...
        <PopoverContent
          align="end"
          sideOffset={8}
          className="w-[360px] p-0 bg-[#1c2030] border-white/10 rounded-xl shadow-2xl"
        >
      ...
      <Popover>
        ...
        <PopoverContent
          align="end"
          sideOffset={8}
          className="w-[380px] p-0 bg-[#1c2030] border-white/10 rounded-xl shadow-2xl"
        >
          <div className="p-4 border-b border-white/5">
            <div className="flex items-center justify-between">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-48 bg-[#131620] border-white/10">
