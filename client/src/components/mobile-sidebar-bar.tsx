    ...
    <>
      ...
      {openPanel && (
        <div className="fixed inset-0 z-[60] md:hidden">
          ...
          {/* Panel */}
          <div
            className={`absolute top-0 bottom-0 w-[85%] max-w-[340px] bg-[#2b2d31] border-white/5 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] flex flex-col ${
              openPanel === "left"
                ? "left-0 border-r"
                : "right-0 border-l"
            }`}
