    ...
    <>
      ...
      {openPanel && (
        <div className="fixed inset-0 z-[60] md:hidden">
          ...
          {/* Panel */}
          <div
            className={`absolute top-0 bottom-0 w-[85%] max-w-[340px] bg-[#1e2a3d] border-white/5 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] flex flex-col ${
              openPanel === "left"
                ? "left-0 border-r"
                : "right-0 border-l"
            }`}
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
        <div className="flex items-center justify-between h-12 bg-[#1e2a3d]/95 backdrop-blur-md border-t border-white/5 px-2">
          {/* Left button */}
