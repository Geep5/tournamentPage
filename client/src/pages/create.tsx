  ...
  return (
    <div className="h-screen bg-background flex flex-col font-sans selection:bg-primary/30 overflow-hidden">
      ...
      <div className="flex flex-1 relative min-h-0 overflow-hidden">
        <main className="flex-1 min-w-0 overflow-y-auto h-full bg-[#172130]/50 scroll-smooth pb-12 xl:pb-0">
          <div className="max-w-6xl mx-auto px-4 md:px-8 py-6 space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {createOptions.map((opt) => (
                <button
                  key={opt.title}
                  className="flex items-start gap-4 p-5 rounded-xl bg-[#1e2a3d] border border-white/5 hover:border-white/10 hover:bg-[#1f2b3c] transition-all text-left group"
                >
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <Select>
                  <SelectTrigger className="bg-[#1e2a3d] border-white/10 text-sm">
              ...
              <div className="space-y-3">
                ...
                <div className="rounded-xl border border-white/5 overflow-hidden">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-[#1e2a3d] border-b border-white/5">
