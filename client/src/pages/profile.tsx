    ...
    <div className="p-4 space-y-6">
      ...
      <div className="flex flex-col items-center">
        <div className="relative">
          ...
          <div className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full bg-blue-500 border-2 border-[#161B22] flex items-center justify-center cursor-pointer hover:bg-blue-600 transition-colors">
            <Pencil className="w-3.5 h-3.5 text-white" />
          </div>
          <div className="absolute top-0 right-0 w-5 h-5 rounded-full bg-blue-500 border-2 border-[#161B22] flex items-center justify-center">
...
- Back to Events: click Events in header`}
      ...
      <div className="flex flex-1 relative min-h-0 overflow-hidden">
        ...
        {/* Left Sidebar */}
        <aside className="w-[280px] flex-col flex-shrink-0 hidden md:flex border-r border-white/5 h-full overflow-y-auto bg-[#161B22] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          {leftSidebarContent}
        </aside>

        {/* Center Content */}
        <main className="flex-1 overflow-y-auto h-full bg-[#111827]/50 scroll-smooth pb-12 md:pb-0">
          <div className="max-w-5xl mx-auto px-4 md:px-8 py-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <Select>
                  <SelectTrigger className="w-[120px] bg-[#1C2230] border-white/10 text-sm">
                ...
                <Select>
                  <SelectTrigger className="w-[160px] bg-[#1C2230] border-white/10 text-sm">
                ...
                <div className="flex-1 min-w-[180px]">
                  <input
                    ...
                    className="w-full bg-[#1C2230] border border-white/10 rounded-lg h-9 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all placeholder:text-muted-foreground/60"
                  />
                </div>
              </div>
              ...
              <div className="space-y-3 pb-6 border-b border-white/5">
                ...
                <div className="space-y-1.5 max-w-lg">
                  ...
                  <input
                    ...
                    className="w-full bg-[#1C2230] border border-white/10 rounded-lg h-10 px-3 text-sm text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
                  />
                </div>
              </div>
